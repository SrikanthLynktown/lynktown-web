                ...
                <div className="container px-5 mt-5 md:mt-10 mx-auto">
                    <div className="flex flex-wrap -m-4">
                        <div className="w-full">
                            <div className="block rounded overflow-hidden relative">
                                <Image
                                ...
                                />
                                <Image
                                        alt="ecommerce" className="object-cover object-center w-5 h-5 absolute top-4  md:left-[280px] left-[130px]  text-[#6C6C6C] block" src="icons/wishlist.svg"
                                        width={459}
                                        height={371}
                                    />
                            </div>
                            <div className="mt-4 mb-5 md:mb-0">
