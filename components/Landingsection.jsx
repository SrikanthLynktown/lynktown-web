    ...
    return (
        <>
            <div className="relative">
                ...
                <div className="absolute top-[20px] left-[380px] md:top-[100px] md:left-[1180px]">
                ...
                <div className="text-gray-600 body-font ">
                    <div className='absolute top-[150px] left-[28px]  md:top-96  md:left-40'>
                        <div className="p-4 md:p-6 w-full h-[206px] md:h-[504px] md:w-[1000px] flex flex-col  bg-white border border-gray-200 rounded-lg shadow md:flex-row ">
                            ...
                            <div className="flex flex-col md:p-14 leading-normal ">
                                <div className='border-dotted border-b-2 border-[#999999] py-2 md:py-6'>
                                    <div className="flex gap-12 md:gap-0">
                                        ...
                                        <div className='flex md:gap-6 md:gap-0 md:ml-40 md:visible invisible '>
                                    ...
                                    <div className="flex gap-28">
                                        <p className='w-[166px] h-[18px] text-[12px] md:text-[23px] font-normal md:w-[320px] md:w-[36px] font-sans md:mb-2'>lynktown.com/ncsboutique</p>
                                ...
                                <div className='flex'>
                                    ...
                                    <div className='py-4'>
                                        <div className='flex gap-2 '>
                                            <Image src="icons/Heart.svg" className='w-[12px] h-[12px] md:w-[23px] md:h-[24px] mt-2 bg-[#FFFFFF]' alt=""
                                                width={23}
                                                height={24}
                                            />
                                            <p className='w-[97px] h-[18px] text-[12] md:text-[23px]  md:w-[148px] md:h-[36px] font-sans'>100k love this</p>
                                        </div>
                                        <div className='flex gap-2'>
                                            <Image src="icons/location.svg" className='w-[12px] h-[14px] md:w-[23px] md:h-[28px] mt-2 bg-[#FFFFFF]' alt=""
                                                width={23}
                                                height={28}
                                            />
                                            <p className='w-full h-[18px] md:w-[252px] md:h-[36px] text-[16px] md:text-[23px] font-normal pt-0.5 md:pt-0'>Kalyan nagar, Bangalore</p>
                                        </div>

                                        <div className='flex gap-2 mt-3'>
                                            <Image src="icons/bag.svg" className='w-[12px] h-[12px] md:w-[23px] md:h-[28px] bg-[#FFFFFF]' alt=""
                                                width={23}
                                                height={28}
                                            />
                                            <p className='w-full h-[18px] text-12 md:w-[398px] md:h-[36px] md:text-[23px] -mt-1.5 md:-mt-0'>Prducts are readymade & Customise</p>
                                        </div>
                                    </div>

                                    <div className='flex gap-4 py-6 mr-4 md:mr-0 md:invisible visible '>
